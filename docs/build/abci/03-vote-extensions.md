...
ABCI2.0 (colloquially called ABCI++) allows an application to extend a pre-commit vote with arbitrary data. This
...
// ADI COMMENT: The link below does not work currently, leading to 404
